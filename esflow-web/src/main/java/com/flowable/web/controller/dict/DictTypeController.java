...
public class DictTypeController {
    ...
    @ResponseBody
    @RequestMapping("list")
    public PageHelper<DictType> findDictType(PageHelper<DictType> page, DictType dictType) {

        return this.dictTypeService.findByParams(ReflectionUtils.beanToMap(dictType),page,  true);
    }
}
